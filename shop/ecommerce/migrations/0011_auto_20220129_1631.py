# Generated by Django 3.2.9 on 2022-01-29 14:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, default='Zimbabwe', max_length=50, null=True)),
                ('order_notes', models.CharField(blank=True, max_length=10000, null=True)),
                ('payment_method', models.CharField(choices=[('Paynow', 'Paynow')], default='Paynow', max_length=20)),
